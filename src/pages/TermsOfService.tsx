...
const TermsOfService: React.FC = () => (
  <>
    <PageMeta
      title="Terms of Service | House of Midas"
      description="Review the terms governing your use of House of Midas services and transactions."
      canonicalUrl={typeof window !== 'undefined' ? `${window.location.origin}/terms-of-service` : '/terms-of-service'}
    />
    <PolicyLayout title="Terms of Service">
      <section>
        <h2 className="text-2xl font-playfair-display font-bold text-[#1a0509] mb-4">Use of Website</h2>
        <p>By accessing the House of Midas website, you agree to comply with our standards of conduct and intellectual property rights.</p>
      </section>
      <section>
        <h2 className="text-2xl font-playfair-display font-bold text-[#1a0509] mb-4">Authenticity</h2>
        <p>Every piece sold through our platform is guaranteed authentic. We reserve the right to verify every transaction for your security.</p>
      </section>
    </PolicyLayout>
  </>
);
